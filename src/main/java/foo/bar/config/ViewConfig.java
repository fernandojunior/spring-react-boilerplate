...
public class ViewConfig extends WebMvcConfigurerAdapter {
     ...
     * <li><code>mustache.js</code> - minimal templating in JavaScript used to render templates/* in render.js</li>
     ...
     * </ul>
     */
    private static final String[] scripts = { "static/js/polyfill.js",
            "static/bower_components/mustache.js/mustache.min.js", "static/js/render.js", "static/app/bundle.js" };

    /**
     * Configures where to find the views that we can render. Since we actually do all the rendering in 'render.js', we
     * only have a single placeholder file.
     */
    @Bean
