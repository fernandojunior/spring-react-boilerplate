 ...
 * our React template, along with an appropriate populated state.
 */
...
public class ErrorController extends AbstractErrorController {
    ...
    /**
     * Render the standard template, but include all the error information we know about. In a production application,
     * you may not want to pass all that information to the client.
     */
